...
c           do j=1,ny1
c              do k=1,nz1
c                 if (xm1(i,j,k,e) .lt. gas_right_boundary) then
c                    vx(i,j,k,e) = 1
c                 else
c                    vx(i,j,k,e) = 0
c                 endif
...
c        call rone(vy(1,1,1,e), nxyz)
c        call rzero(vz(1,1,1,e), nxyz)
c        call rone (vtrans(1,1,1,e,irho), nxyz)
c        call rone (energy, nxyz)
