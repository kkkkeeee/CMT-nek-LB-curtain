...
c
      ...
      endtime = dnekclock()
      if( mod(nid, np/2) .eq. np/2-2) then
          print *, "readat time", endtime - starttime
      endif
 ...
 12      format(1X,A,4I12,/,/)
      ...
      endtime = dnekclock()
      if( mod(nid, np/2) .eq. np/2-2) then
          print *, "setvar time", endtime - starttime
      endif
...
!#endif
      ...
      endtime = dnekclock()
      if( mod(nid, np/2) .eq. np/2-2) then
          print *, "setup topo time", endtime - starttime
      endif
      ...
      endtime = dnekclock()
      if( mod(nid, np/2) .eq. np/2-2) then
          print *, "genwz time", endtime - starttime
      endif
      ...
      endtime = dnekclock()
      if( mod(nid, np/2) .eq. np/2-2) then
          print *, "io init time", endtime - starttime
      endif
...
!     $   call cv_setsize(0,nfield) !Set size for CVODE solver
      ...
      endtime = dnekclock()
      if( mod(nid, np/2) .eq. np/2-2) then
          print *, "usrdat", endtime - starttime
      endif
